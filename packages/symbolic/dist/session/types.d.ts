 ...
 */
import type { FormativeBrief, SymbolicInterpretation, TreeStructuralAnalysis, TreeStructuralState } from '../tree';
import type { SafetyRole } from '../tree/clinical-lexicon';
export type { SafetyRole };
/** Ordered lifecycle stages of an assisted session. */
export type SessionStage = 'intake' | 'structural' | 'assisted_interpretation' | 'session_notes' | 'exercises' | 'closed';
export declare const SESSION_STAGE_ORDER: readonly SessionStage[];
