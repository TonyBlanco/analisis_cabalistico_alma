  ...
  return (
    <aside className="w-64 border-r border-gray-200 bg-white flex flex-col">
            ...
            {cabalisticSystems.map((system) => {
              ...
              return (
                <button
                  ...
                  className={`w-full rounded-md border px-3 py-2 text-left text-sm transition-colors ${isSelected ? selectedClasses : idleClasses
                    }`}
                >
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <span
                      className={`flex items-center gap-1 text-[10px] uppercase tracking-wide ${isImplemented ? 'text-emerald-700' : 'text-amber-700'
                        }`}
                    >
      ...
      <div className="px-3 py-2 border-t border-gray-100">
        <SwmV3Button systemId={selectedSystem || 'thoth'} />
      </div>
