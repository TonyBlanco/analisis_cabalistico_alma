 ...
 */
export const SEFIROT_TOPOLOGY: Record<SefiraId, SefirotTopoEntry> = {
 ...
 */
export const TREE_PATHS: readonly TreePath[] = [
...
export const VALID_SEFIRA_IDS: readonly SefiraId[] = [
