import { latinToHebrew, calcMilui, calcGematriaStandard, reduceToSingleDigit, findKnownWords, numberToSefira, MILUI_NAMES, GEMATRIA_STANDARD } from '../../utils/hebrew-gematria';
/**
 * Calcula Milui (Expansión/Relleno)
 * Cada letra se expande a su nombre completo (א → אלף)
 */
export function calcularAnalisisMilui(input) {
