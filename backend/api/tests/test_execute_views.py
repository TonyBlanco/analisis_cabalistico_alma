...
class ExecuteTestAPITests(TestCase):
    def setUp(self):
        ...
        TestModule.objects.create(code='scl-90', name='SCL-90', test_type='scl90', is_active=True)
        TestModule.objects.create(code='stai', name='STAI', test_type='stai', is_active=True)
        TestModule.objects.create(code='mcmi-iv', name='MCMI-IV', test_type='mcmi-iv', is_active=True, requires_license=True)
        TestModule.objects.create(code='scid5', name='SCID-5', test_type='scid5', is_active=True, requires_license=True)
