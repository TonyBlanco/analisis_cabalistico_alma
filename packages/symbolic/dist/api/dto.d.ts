...
import type { SymbolicInterpretation, SymbolicSafetyLevel } from '../tree/symbolic-interpreter.types';
...
export declare const SYMBOLIC_API_VERSION: "v1";
...
export type CorrespondenceSefirahDataV1 = SefirahCorrespondence | TraditionalSefirahData;
export type CorrespondencePathDataV1 = PathCorrespondence | SeferYetzirahLetter;
