...
export const MARKETPLACE_RESOURCES: MarketplaceResource[] = [
  ...
  {
    id: 'test-pai',
    name: 'PAI - Evaluación Profesional Completa',
    description: 'Inventario de Evaluación de Personalidad para diagnóstico clínico profesional',
    type: 'test_module',
    category: 'tests',
    requiredAccess: 'professional',
    icon: '🧾',
    features: [
      'Escalas clínicas completas',
      'Interpretación profesional',
      'Reporte para pacientes',
  ...
  {
    id: 'test-mcmi-iv',
    name: 'MCMI-IV - Evaluación de Personalidad',
    description: 'Inventario Clínico Multiaxial de Millon para trastornos de personalidad',
    type: 'test_module',
    category: 'tests',
    requiredAccess: 'professional',
    icon: '🧩',
    features: [
      ...
      '10 escalas clínicas',
      'Algoritmo diagnóstico avanzado',
      'Compatible con DSM-5',
    ],
    isPremium: true,
    usageLimit: 30,
    createdAt: '2024-01-01',
  ...
  {
    id: 'test-scid5',
    name: 'SCID-5-RV - Entrevista Estructurada DSM-5',
    description: 'Entrevista clínica estructurada para diagnóstico DSM-5',
    type: 'test_module',
    category: 'tests',
    requiredAccess: 'professional',
    icon: '🔎',
    features: [
      'Protocolo DSM-5 completo',
      'Guía de entrevista estructurada',
      'Algoritmos diagnósticos',
      'Reporte profesional detallado',
    ],
    isPremium: true,
    usageLimit: 40,
    createdAt: '2024-01-01',
