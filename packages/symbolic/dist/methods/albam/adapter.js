...
export function generarAnalisisAlbam(i) {
    return calcularAnalisisAlbam(i);
}
export function adaptarAEstadoSimbolicoAlbam(r) {
    const pk = [
...
export function ejecutarMetodoAlbam(i) {
