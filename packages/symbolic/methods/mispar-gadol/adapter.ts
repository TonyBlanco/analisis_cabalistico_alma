...
export function generarAnalisisMisparGadol(i: MisparGadolInput) {
	return calcularAnalisisMisparGadol(i) as any;
}

export function adaptarAEstadoSimbolicoMisparGadol(r: any): any {
	const pk = [
		{
			key: 'esencia',
			label: 'Esencia',
...
export function ejecutarMetodoMisparGadol(i: MisparGadolInput) {
