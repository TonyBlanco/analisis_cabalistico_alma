import { latinToHebrew, calcMisparSiduri, reduceToSingleDigit, numberToSefira, MISPAR_SIDURI, GEMATRIA_STANDARD } from '../../utils/hebrew-gematria';
/**
 * Calcula Mispar Siduri (Ordinal)
 * Posición en el alfabeto: א=1, ב=2, ... ת=22
 */
export function calcularAnalisisMisparSiduri(input) {
