  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
      <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
        <h1 className="text-2xl font-semibold text-gray-900">{isiDefinition.name}</h1>
        <p className="text-sm text-gray-600 mt-2">
          {isiDefinition.purpose} para {isiDefinition.target_population}. Tiempo estimado {isiDefinition.estimated_time_minutes} minutos.
        </p>
