...
export function generarAnalisisTemurah(i: TemurahInput) {
	return calcularAnalisisTemurah(i) as any;
}

export function adaptarAEstadoSimbolicoTemurah(r: any): any {
	const pk = [
...
export function ejecutarMetodoTemurah(i: TemurahInput) {
