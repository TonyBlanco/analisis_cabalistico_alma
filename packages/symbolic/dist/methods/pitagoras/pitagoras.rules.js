 ...
 */
export function reducirTeosofica(n) {
    if (n === 0)
        return 0;
    if (n < 0)
        n = Math.abs(n);
 ...
 */
export function reducirPitagorica(valor) {
 ...
 */
export function calcularValorLetra(letra) {
 ...
 */
export function calcularValoresNombre(nombreCompleto) {
 ...
 */
export function calcularCaminoDestino(dia, mes, anio) {
    // Suma todos los dígitos de la fecha
    const sumaTotal = reducirTeosofica(dia) +
 ...
 */
export function calcularInclusion(letras) {
    const casas = {};
 ...
 */
export function identificarAusencias(casas) {
 ...
 */
export function identificarDominantes(casas) {
 ...
 */
export function calcularAnalisisPitagorico(input) {
