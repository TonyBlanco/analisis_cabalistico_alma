...
export function generarAnalisisGematriaStandard(input: GematriaStandardInput) {
  // Reuse rules to build a simple result object similar to Pitagoras
  return calcularAnalisisGematriaStandard(input) as any;
}

export function adaptarAEstadoSimbolicoGematria(result: any): any {
...
export function ejecutarMetodoGematriaStandard(input: GematriaStandardInput): any {
