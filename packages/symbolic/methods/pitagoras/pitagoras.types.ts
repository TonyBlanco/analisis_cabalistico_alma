...
export interface PitagorasResult {
  ...
  numeros: {
    ...
    esencia: NumeroReducido & { significado: PitagorasNumberMeaning };
    
    /** Expresión/Personalidad (suma de consonantes) */
    expresion: NumeroReducido & { significado: PitagorasNumberMeaning };
    
    /** Herencia/Destino (suma total del nombre) */
    herencia: NumeroReducido & { significado: PitagorasNumberMeaning };
