...
export function generarAnalisisAtbash(i: AtbashInput) {
	return calcularAnalisisAtbash(i) as any;
}

export function adaptarAEstadoSimbolicoAtbash(r: any): any {
	const pk = [
...
export function ejecutarMetodoAtbash(i: AtbashInput) {
