...
export function generarAnalisisAvgad(i) {
    return calcularAnalisisAvgad(i);
}
export function adaptarAEstadoSimbolicoAvgad(r) {
    const pk = [
...
export function ejecutarMetodoAvgad(i) {
