 ...
 */
export function generarAnalisisPitagorico(input: PitagorasInput): PitagorasResult {
  ...
  const casas: PitagorasResult['inclusion']['casas'] = {};
  for (let i = 1; i <= 9; i++) {
  ...
  const resultado: PitagorasResult = {
    identidad: {
      nombreCompleto,
 ...
 */
export function adaptarAEstadoSimbolico(resultado: PitagorasResult): PitagorasSymbolicState {
  ...
  const inclusionMap: PitagorasSymbolicState['inclusionMap'] = {};
  for (let i = 1; i <= 9; i++) {
 ...
 */
export function ejecutarMetodoPitagorico(input: PitagorasInput): PitagorasSymbolicState {
