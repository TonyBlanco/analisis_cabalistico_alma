...
export function generarAnalisisMilui(i: MiluiInput) {
	return calcularAnalisisMilui(i) as any;
}

export function adaptarAEstadoSimbolicoMilui(r: any): any {
	const pk = [
...
export function ejecutarMetodoMilui(i: MiluiInput) {
