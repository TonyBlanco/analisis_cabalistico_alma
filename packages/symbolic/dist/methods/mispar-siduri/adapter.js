...
export function generarAnalisisMisparSiduri(i) {
    return calcularAnalisisMisparSiduri(i);
}
export function adaptarAEstadoSimbolicoMisparSiduri(r) {
    const pk = [
...
export function ejecutarMetodoMisparSiduri(i) {
