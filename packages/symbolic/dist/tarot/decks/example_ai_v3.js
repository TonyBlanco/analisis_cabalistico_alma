...
export const EXAMPLE_AI_V3_MAJOR_ARCANA = [
    {
        id: 'the_fool_example',
        ...
        interpretativeHints: 'Observe patterns of openness and potential; encourage questions rather than prescriptions.',
    ...
    },
    {
        ...
        interpretativeHints: 'Highlight available resources and methods; frame as exploratory options for the consultante.',
        sources: ['example: symbolic mapping'],
        example: true,
        nonProduction: true,
    },
    {
        ...
        interpretativeHints: 'Invite reflective inquiry and note tensions between inner knowing and external demands.',
        sources: ['example: symbolic mapping'],
        example: true,
        nonProduction: true,
    },
