            ...
            <div className="space-y-3">
              ...
              <label className="flex items-start gap-3 cursor-pointer group hover:bg-slate-700/30 p-3 rounded-lg transition-colors">
                <input
                  ...
                  className="mt-1 w-5 h-5 rounded border-slate-600 bg-slate-800 text-amber-500 focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 focus:ring-offset-slack-900 cursor-pointer"
                />
                <div className="flex-1">
