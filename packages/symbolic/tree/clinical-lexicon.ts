 ...
 */
export const CLINICAL_LEXICON_TERMS: readonly string[] =
  SYMBOLIC_INTERPRETER_META.prohibitedTerms;
 ...
 */
export const ANTI_FRAUD_TERMS: readonly string[] = [
 ...
 */
export function enforceAntiFraudRail(content: string): SafetyValidationResult {
 ...
 */
export function validateSafetyContentForRole(
  content: string,
