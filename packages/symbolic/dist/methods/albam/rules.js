import { latinToHebrew, albamTransform, calcGematriaStandard, reduceToSingleDigit, findKnownWords, numberToSefira, GEMATRIA_STANDARD } from '../../utils/hebrew-gematria';
/**
 * Calcula Albam - Primera mitad ↔ Segunda mitad del alfabeto
 * א↔ל, ב↔מ, ג↔נ, etc. (offset de 11 posiciones)
 */
export function calcularAnalisisAlbam(input) {
