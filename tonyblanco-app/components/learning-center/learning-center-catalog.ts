...
export const learningCenterCatalogDefinition: LearningCenterCatalogDefinition = {
  ...
  guides: [
    ...
    {
      slug: 'transgeneracional-profundo',
      title: 'Árbol transgeneracional',
      summary: 'Cómo construir el árbol genealógico del consultante, registrar personas con campos Armoni y anotar eventos históricos observados.',
      category: 'Workspaces',
      docPath: 'learning-center/guides/transgeneracional-profundo.md',
    },
    {
      slug: 'resonancia-ancestral',
      title: 'Resonancia Ancestral',
      summary: 'Cómo registrar resonancias entre generaciones (Armoni y Hellinger), vincular personas del árbol y habilitar la captura del consultante.',
      category: 'Workspaces',
      docPath: 'learning-center/guides/resonancia-ancestral.md',
    },
    {
      slug: 'tests-holisticos',
      title: 'Tests holísticos',
      summary: 'Qué tests holísticos hay disponibles, cómo asignarlos, qué ve el consultante y qué ve el terapeuta en el resultado.',
      category: 'Tests',
      docPath: 'learning-center/guides/tests-holisticos.md',
    },
    {
      slug: 'reportes-del-terapeuta',
      title: 'Reportes',
      summary: 'Cómo usar el panel de reportes para revisar alertas de tests completados, ver la cartera de consultantes y exportar datos CSV.',
      category: 'Metricas',
      docPath: 'learning-center/guides/reportes-del-terapeuta.md',
    },
  ],
  faq: {
    title: 'FAQ de uso',
