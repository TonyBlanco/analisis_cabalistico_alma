        ...
        <div className="space-y-6 py-4">
          ...
          <div className="text-center space-y-4">
            <p className="text-lg leading-relaxed text-slate-300">
              Bienvenido/a. Lo que estás a punto de iniciar no es un examen para juzgarte, ni un{' '}
              {type === 'test' ? 'test' : 'análisis'} para etiquetarte. Considéralo una{' '}
              <span className="text-amber-400 font-medium">brújula</span>.
            </p>
            <p className="text-base leading-relaxed text-slate-400">
              Para poder acompañarte a elevar tu consciencia y trabajar en la sanación de tu alma, necesitamos saber
              dónde estás hoy. Tus respuestas son las <span className="text-amber-400">coordenadas</span> que nos
              ayudarán a trazar el mapa de regreso a tu esencia.
            </p>
          </div>
            ...
            <div className="space-y-3">
              <label className="flex items-start gap-3 cursor-pointer group hover:bg-slate-700/30 p-3 rounded-lg transition-colors">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-slate-400 mt-1">
                    Me comprometo a responder con sinceridad, entendiendo que no hay respuestas &quot;correctas&quot; o
                    &quot;incorrectas&quot;, solo mi realidad actual.
                  </p>
                </div>
              </label>
              ...
              <label className="flex items-start gap-3 cursor-pointer group hover:bg-slate-700/30 p-3 rounded-lg transition-colors">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-slate-400 mt-1">
                    Entiendo que toda la información que comparta aquí es confidencial y sagrada, utilizada únicamente
                    para mi proceso de crecimiento. Puedo solicitar la eliminación de mis datos al finalizar mi terapia.
                  </p>
                </div>
              </label>
              ...
              <label className="flex items-start gap-3 cursor-pointer group hover:bg-slate-700/30 p-3 rounded-lg transition-colors">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-slate-400 mt-1">
                    Acepto iniciar esta exploración consciente y permitir el uso de mis datos para este{' '}
                    {type === 'test' ? 'test' : 'análisis'} y su interpretación terapéutica.
                  </p>
                </div>
              </label>
            </div>
          ...
          <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4 text-center">
            <p className="text-sm text-amber-300 italic">
              💫 Sugerencia: Cierra los ojos, toma una respiración profunda por la nariz, y al exhalar, suelta cualquier
              expectativa. Ahora, cuando estés listo/a, continúa.
            </p>
          </div>
