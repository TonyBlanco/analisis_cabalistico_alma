...
export function generarAnalisisNotarikon(i: NotarikonInput) {
	return calcularAnalisisNotarikon(i) as any;
}

export function adaptarAEstadoSimbolicoNotarikon(r: any): any {
	const pk = [
...
export function ejecutarMetodoNotarikon(i: NotarikonInput) {
