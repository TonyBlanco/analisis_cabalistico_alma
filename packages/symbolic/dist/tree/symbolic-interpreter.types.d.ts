 ...
 */
export type SymbolicObservationType = 'pattern-recognition' | 'structural-analysis' | 'symbolic-comparison' | 'educational-context';
/**
...
export declare const SYMBOLIC_INTERPRETER_META: SymbolicInterpreterMeta;
//# sourceMappingURL=symbolic-interpreter.types.d.ts.map